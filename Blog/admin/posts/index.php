                   ...
                   <div class="col-md-3 admin-sidebar">
                     <h5 class="side-bar-title" >Control Panel</h5>
                      <ul class="nav flex-column">
                          <li class="nav-item">
                            <a class="nav-link active" href="index.php">Manage Posts</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="../users/index.php">Manage Users</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="../topics/index.php">Manage Topics</a>
                          </li>
                        </ul>
...
<!--                   abmin-main section-->
                  <div class="col-md-9 admin-main-section">
                      ...
                      <a class="btn btn-secondary" href="#" role="button">Manage Posts</a>
